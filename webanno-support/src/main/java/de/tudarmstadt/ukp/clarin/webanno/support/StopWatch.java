...
public class StopWatch implements AutoCloseable
{
    ...
    public StopWatch(String aId)
    {
        this(aId, LOG);
    }

    public StopWatch(String aId, Logger aLogger)
    {
        this(aId, aLogger, Level.DEBUG);
    }

    public StopWatch(String aId, Logger aLogger, Level aLevel)
    {
        id = aId;
        log = aLogger;
        level = aLevel;
    ...
    private String getMessage()
    {
        ...
        return "[" + id + "] completed in " + duration + "ms";
    }
